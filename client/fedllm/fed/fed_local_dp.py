...
class DataCollatorForPrivateCompletionOnlyLM(DataCollatorForCompletionOnlyLM):
    def __init__(self, response_template_ids, tokenizer):
        super().__init__(response_template_ids, tokenizer=tokenizer)
...
class OpacusDPTrainer(Trainer):
    ...
    def num_steps(self) -> int:
        ...
        # return int(self.train_args.max_steps * self.round * 0.1)
